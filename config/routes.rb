Rails.application.routes.draw do
  ...
  if Rails.env.production?
    ...
    devise_for :users, :controllers => {:omniauth_callbacks => "users/omniauth_callbacks" } # restrict registrations { :registrations => "registrations" }
  end
  ...
  resources :posts, :path => '/posts', :concerns => :paginatable
  resources :tag, :except => :index do
    collection do
      get 'tag', :action => 'show'
    end
  end
